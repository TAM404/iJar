<template>
  <div class="e  flex justify-center items-center  min-h-screen bg-gray-100" style="font-family: Poppins, sans-serif">
  ...
  methods: {
    ...
    async signup(){
      const userStore = useUserStore();
        try{
          const response = await userStore.signUp({ //email, password, name, phonenumber, birthday, locations, favorites
        ...
        this.errors.error = err.message || 'Registration failed. Please try again.';
      } finally {
        this.loading = false;
      }
    }
