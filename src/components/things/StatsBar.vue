    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative" style="font-family:Poppins,sans-serif;max-width: 98rem">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4" style="border-bottom-width: 1px;">
        ...
        <div class="flex items-center p-3 bg-white custom-shadow transition-shadow duration-300 border-b">
          ...
          <div class="ml-3">
            <span v-if="!isEditMode" class="mytext-2xl font-medium text-gray-800 block">{{ agency.yearFounded }}</span>
            <input
                v-else
                type="number"
                v-model="editedAgency.yearFounded"
        ...
        <div class="flex items-center p-3 bg-white custom-shadow transition-shadow duration-300 border-b">
          ...
          <div class="ml-3">
            <span v-if="!isEditMode" class="mytext-2xl font-medium text-gray-800 block">{{ agency.propertiesSold }}+</span>
            <div v-else class="flex items-center">
              <input
                  type="number"
                  v-model="editedAgency.propertiesSold"
                  class="mytext-2xl font-medium text-gray-800 block w-20 border border-gray-300 rounded px-2"
              />
        ...
        <div class="flex items-center p-3 bg-white custom-shadow transition-shadow duration-300 border-b">
          ...
          <div class="ml-3">
            <span v-if="!isEditMode" class="mytext-2xl font-medium text-gray-800 block">{{ agency.agentsCount }}</span>
            <input
                v-else
                type="number"
                v-model="editedAgency.agentsCount"
                class="mytext-2xl font-medium text-gray-800 block w-20 border border-gray-300 rounded px-2"
            />
        ...
        <div class="flex items-center p-3 bg-white custom-shadow transition-shadow duration-300 border-b">
          ...
          <div class="ml-3">
            <span v-if="!isEditMode" class="mytext-2xl font-medium text-gray-800 block">{{ agency.clientSatisfaction }}%</span>
            <div v-else class="flex items-center">
              <input
                  type="number"
                  v-model="editedAgency.clientSatisfaction"
                  class="mytext-2xl font-medium text-gray-800 block w-20 border border-gray-300 rounded px-2"
                  min="0"
                  max="100"
              />
