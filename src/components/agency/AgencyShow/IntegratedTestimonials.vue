<template>
  <section class="py-16 px-4 bg-white rounded-2xl shadow-xl p-8 transform transition-all duration-300 hover:shadow-2xl" style="margin-top: 80px">
    <div class="max-w-6xl mx-auto">
      <!-- Section intro -->
      <div class="text-center mb-12">
        <h2 class="text-4xl font-bold text-gray-900 mb-4">Client Experiences</h2>
