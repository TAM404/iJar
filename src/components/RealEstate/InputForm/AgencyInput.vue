<template>
  ...
  <div class="min-h-screen bg-white flex items-center justify-center p-6">
    ...
    border: 1px solid #7c86b9;
    border-radius: 20px;
    /* color: rgb(119 117 197); */
    /* background: linear-gradient(90deg, rgb(26 24 24 / 39%), rgba(200, 200, 200, 0.35)); */
    /* -webkit-background-clip: text; */
    -webkit-text-fill-color: #00000021;
    background: url(https://github.com/misalagp/imgs/blob/main/noise.png?raw=true), radial-gradient(circle, #7076ad61 0%, #2e3763c9 100%);">{{ currentStep + 1 }}</h1>
    ...
    padding-top: 114px;
    top: 303px;
    border: 1px solid rgb(124, 134, 185);
    border-radius: 20px;
    -webkit-text-fill-color: rgba(0, 0, 0, 0.13);
    background: url(https://github.com/misalagp/imgs/blob/main/noise.png?raw=true), radial-gradient(circle, rgba(112, 118, 173, 0.38) 0%, rgba(46, 55, 99, 0.79) 100%);
...
<script>
import ProgressIndicator from "@/components/RealEstate/InputForm/ProgressIndicator.vue";
import BasicAgencyInfo from "@/components/RealEstate/InputForm/BasicAgencyInfo.vue";
import ServicesContactDetails from "@/components/RealEstate/InputForm/ServicesContactDetail.vue";
import PerformanceAchievements from "@/components/RealEstate/InputForm/PerformanceAchievements.vue";
import NavigationButtons from "@/components/RealEstate/InputForm/NavigationButtons.vue";
...
export default {
  ...
  methods: {
    ...
    submitAgencyData() {
      ...
      alert('Agency Information Completed!')
    }
  }
}
</script>
